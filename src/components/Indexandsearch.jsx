...
function Indexandsearch() {
    ...
    const getResult = (cName) => {
        console.log(cName)
        let query = `${API_URL}forecast.json?q=${cName}&days=7&key=${key}`
        console.log(query)
        fetch(query)
    ...
    useEffect(() => {
        params.city && getResult(params.city)
                            ...
                            <div className="content">
                                ...
                                <div className="row4">
                                    ...
                                    <div className="daytime-stuff">
                                        ...
                                        <div className="daytime">
                                            {getDayTime(result.forecast.forecastday[0].astro.sunset, result.forecast.forecastday[0].astro.sunrise)}</div>
                                ...
                                <div className="row5">
                                    <div className="next-day1-stuff">
                                        <div> <img height="44px" className="icon-image1" src={(result.forecast.forecastday[1].day.condition.icon)}
                                            alt="hava durumu ikonu " /> </div>
                                    ...
                                    <div className="next-day2-stuff">
                                        <div> <img height="44px" className="icon-image2" src={result.forecast.forecastday[2].day.condition.icon}
                                            alt="hava durumu ikonu " /> </div>
                                    ...
                                    <div className="next-day3-stuff">
                                        <div> <img height="44px" className="icon-image3" src={result.forecast.forecastday[3].day.condition.icon}
                                            alt="hava durumu ikonu " /> </div>
                                    ...
                                    <div className="next-day4-stuff">
                                        <div> <img height="40px" className="icon-image4" src={result.forecast.forecastday[4].day.condition.icon}
                                            alt="hava durumu ikonu " /> </div>
                                    ...
                                    <div className="next-day5-stuff">
                                        <div> <img height="40px" className="icon-image5" src={result.forecast.forecastday[5].day.condition.icon}
                                            alt="hava durumu ikonu " /> </div>
                                    ...
                                    <div className="next-day6-stuff">
                                        <div> <img height="40px" className="icon-image6" src={result.forecast.forecastday[6].day.condition.icon}
                                            alt="hava durumu ikonu " /> </div>
